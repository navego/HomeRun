...
class AuthController extends Controller {
	...
	public function getLogin() {
		...
		return view('frontend.auth.login', compact('socialProviders'));
	}
	...
	public function getToken() {
		return session('auth.2fa.id') ? view('frontend.auth.token') : redirect('login');
	}
	...
	public function getRegister() {
		...
		return view('frontend.auth.register', compact('socialProviders'));
	}
